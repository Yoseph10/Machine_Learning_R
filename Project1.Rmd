...
e) Muestre un dataframe que resuma los resultado
...
5) Ahora intentaremos predecir la tasa de criminalidad per c´apita en los datos de Boston, del ISLR2 library.
